...
//
//	mockgen -source=../../pkg/db.go -destination=../../mocks/db_mock.go -package=mocks
//
...
func (m *MockDatabase) Begin(ctx context.Context) (pkg.Tx, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) Exec(ctx context.Context, sql string, args ...any) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
...
func (m *MockDatabase) Query(ctx context.Context, sql string, args ...any) (pkg.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockDatabase) QueryRow(ctx context.Context, sql string, args ...any) pkg.Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockRow) Scan(dst ...any) error {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range dst {
		varargs = append(varargs, a)
...
func (mr *MockRowMockRecorder) Scan(dst ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Scan", reflect.TypeOf((*MockRow)(nil).Scan), dst...)
}
...
// Scan indicates an expected call of Scan.
func (mr *MockRowsMockRecorder) Scan(dst ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Scan", reflect.TypeOf((*MockRows)(nil).Scan), dst...)
}
